...
image = np.zeros((120, 600, 3), np.uint8)
...
cv2.putText(image, a[0].rstrip("\n"), (10, 35), cv2.FONT_HERSHEY_COMPLEX, 1, white, 2)
cv2.putText(image, a[1].rstrip("\n"), (10, 70), cv2.FONT_HERSHEY_COMPLEX, 1, white, 2)
cv2.putText(image, a[2].rstrip("\n"), (10, 105), cv2.FONT_HERSHEY_COMPLEX, 1, white, 2)
